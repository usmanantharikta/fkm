...
class Employee_model extends CI_Model {
  //declar variable
  	var $table_person = 'person'; // crud tabel on menu employee
    var $column = array('id_employ','name','gender','departement','division','location'); //set column field database on tabel person for order and search
